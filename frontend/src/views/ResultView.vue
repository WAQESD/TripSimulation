...
for (let i = 1; i <= 5; i++) placeList.push({ ...placeList[0], placeId: i });
</script>
...
<template>
  <div>
    ...
    <div class="path-result-container">
      <div class="path-result-center-line" :style="{ height: placeList.length * 450 + 210 + 'px' }">
      ...
      <div class="path-result-btn-container"><button class="path-result-btn">경로 저장하기</button></div>
    </div>
  </div>
</template>
